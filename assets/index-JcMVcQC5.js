...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function io(e,t,n){let r=new Float32Array(Wa),i=new J(0,1,0);return new ki({name:`SphericalGaussianBlur`,defines:{n:Wa,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:so(),fragmentShader:`
	...
	`}var co=class extends Tt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Br(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
  ...
  `,uniforms:{uEnvMap:{value:d},uB:{value:1.52},uC:{value:.15},uEnvInt:{value:5.5},uOpacity:{value:.05},uRefl:{value:2.8},uCamPos:{value:i.position},uHalf:{value:new J(1,1,1)},uTint:{value:new Z(16777215)}},transparent:!0,depthWrite:!1,side:2,glslVersion:Re}),h=(e,t)=>new Xc(e,e,e,3,t);function g(e,t,n,i,a){let o=a.clone();o.uniforms.uHalf.value.setScalar(n);let s=new Or(h(e,t),o);return s.position.copy(i),r.add(s),s}let _=window.innerWidth<768,v=[g(2,.05,.95,new J(_?-2.5:-4,_?-1.4:-1,0),m),g(1.2,.03,.57,new J(_?2.8:3.5,_?3.2:2.5,2),m),g(3,.07,1.43,new J(_?1.5:5,_?-4.5:-3,-3),m)],y=document.getElementById(`manifesto-canvas`),b,x,S,C,w,T=0;if(y){b=new dn,b.environment=r.environment;let e=y.clientWidth||window.innerWidth,t=y.clientHeight||600;x=new qc({canvas:y,alpha:!0,antialias:!0}),x.setPixelRatio(window.innerWidth<768?1:Math.min(window.devicePixelRatio,1.5)),x.setSize(e,t),x.toneMapping=4,x.toneMappingExposure=1,S=new sa(40,e/t,.1,100),S.position.set(0,0,11);class n extends Kr{constructor(e=1.6,t=2.2,n=10.5,r=0){super(),this.radius=e,this.turns=t,this.height=n,this.phase=r}getPoint(e,t=new J){let n=e*Math.PI*2*this.turns+this.phase;return t.set(Math.cos(n)*this.radius,(e-.5)*this.height,Math.sin(n)*this.radius)}}let i=new n(1.5,2.2,10.5,0),a=new n(1.5,2.2,10.5,Math.PI),o=new bi(i,160,.26,32,!1),s=new bi(a,160,.26,32,!1),c=new ki({vertexShader:`
    ...
    `,uniforms:{uEnvMap:{value:d},uB:{value:1.52},uC:{value:.16},uEnvInt:{value:3.8},uOpacity:{value:.04},uRefl:{value:2.2},uCamPos:{value:S.position},uTint:{value:new Z(16183295)},uTime:{value:0}},transparent:!0,depthWrite:!1,glslVersion:Re});C=new Or(o,c),w=new Or(s,c.clone());let l=window.innerWidth<768;C.position.x=l?1.8:3.2,w.position.x=l?1.8:3.2;let u=l?1.05:1;C.scale.set(u,u,u),w.scale.set(u,u,u),b.add(C),b.add(w)}let E=document.getElementById(`shader-bg`),D,O,k,A;if(E){D=new qc({canvas:E,antialias:!1}),D.setPixelRatio(window.innerWidth<768?1:Math.min(window.devicePixelRatio,1.5)),D.setSize(window.innerWidth,window.innerHeight),O=new dn,k=new ca(-1,1,1,-1,0,1),A=new ki({vertexShader:`
      varying vec2 vUv;
      void main() {
        vUv = uv;
        gl_Position = vec4(position, 1.0);
    ...
    `,uniforms:{uTime:{value:0},uResolution:{value:new q(window.innerWidth,window.innerHeight)},uMouse:{value:new q(window.innerWidth/2,window.innerHeight/2)}},depthWrite:!1});let e=new Or(new yi(2,2),A);O.add(e),document.addEventListener(`mousemove`,e=>{A.uniforms.uMouse.value.set(e.clientX,window.innerHeight-e.clientY)})}v.forEach((e,t)=>{let n=4+Math.random()*2;gsap.to(e.position,{y:e.position.y+1.2,duration:n,ease:`sine.inOut`,yoyo:!0,repeat:-1,delay:t*.5}),gsap.to(e.rotation,{x:`+=`+Math.PI*2,y:`+=`+Math.PI*2,duration:15+t*5,ease:`none`,repeat:-1})});let ee=new Oa,j=0;function M(){t.render(r,i),D&&D.render(O,k),y&&x&&x.render(b,S),j++,j<3?requestAnimationFrame(M):window.startIntro&&window.startIntro()}requestAnimationFrame(M);let N=!0,P=!1,F=new IntersectionObserver(e=>{e.forEach(e=>{(e.target.id===`heroBg`||e.target.id===`hero`)&&(N=e.isIntersecting),(e.target.id===`manifesto-canvas`||e.target.id===`about`)&&(P=e.isIntersecting)})},{rootMargin:`200px`}),te=document.getElementById(`hero`),ne=document.getElementById(`about`);te&&F.observe(te),ne&&F.observe(ne);function re(){requestAnimationFrame(re),N&&(D&&(A.uniforms.uTime.value=ee.getElapsedTime(),D.render(O,k)),v.forEach(e=>{e.material?.uniforms?.uCamPos&&e.material.uniforms.uCamPos.value.copy(i.position)}),t.render(r,i)),P&&y&&x&&(T+=.015,C.rotation.y-=.008,w.rotation.y-=.008,C.material.uniforms.uTime.value=T,w.material.uniforms.uTime.value=T,C.material.uniforms.uCamPos.value.copy(S.position),w.material.uniforms.uCamPos.value.copy(S.position),x.render(b,S))}re(),window.addEventListener(`resize`,()=>{if(i.aspect=window.innerWidth/window.innerHeight,i.updateProjectionMatrix(),t.setSize(window.innerWidth,window.innerHeight),D&&(D.setSize(window.innerWidth,window.innerHeight),A.uniforms.uResolution.value.set(window.innerWidth,window.innerHeight)),y&&x){let e=y.clientWidth,t=y.clientHeight;S.aspect=e/t,S.updateProjectionMatrix(),x.setSize(e,t)}})};document.readyState===`loading`?document.addEventListener(`DOMContentLoaded`,Zc):Zc();